...
## Number of days per year above or equal to 25C, 28C, 39C, 35C
```{r}
dat.wbgt.summarised = dat.wbgt %>%
  ...
  dplyr::summarise(wbgt_25=sum(wbgt_25), wbgt_28=sum(wbgt_28), wbgt_30=sum(wbgt_30), wbgt_35=sum(wbgt_35))
```
