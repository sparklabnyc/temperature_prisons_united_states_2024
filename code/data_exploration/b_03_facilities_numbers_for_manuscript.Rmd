...
num_person_days <- fig1a_data %>% filter(Type == "Total") %>% 
...
```{r}
shapefile.data %>% filter(STATE == "FL" & Type == "STATE") %>% 
...
## Identify facility with largest number of dangerous humid-hot days
```{r}
