...
gridExtra::grid.arrange(as_grob(plot.bar.chart.26),
                        as_grob(plot.count.last.5.years.26),
                        widths = c(4, 4),
...
gridExtra::grid.arrange(as_grob(plot.bar.chart.28),
                        as_grob(plot.count.last.5.years.28),
                        widths = c(4, 4),
                        layout_matrix = rbind(c(1, 2),
                                              c(1, 2)),
                        nrow=2) 
