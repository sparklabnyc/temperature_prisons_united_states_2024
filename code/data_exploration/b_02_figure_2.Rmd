...
## Save heatmap data out
```{r}
readr::write_csv(dat.wbgt.summarised.merged.weighted.prison.state ,paste0(wbgtmax.folder,'Figure_2_heatmap.csv'))
```
...
plot_start_year = function(threshold_chosen,legend_chosen=0){
  p = ggplot() +
    geom_polygon(data=us_aea,aes(x=long,y=lat,group=group),fill='grey',color='black',size=0.2) +
