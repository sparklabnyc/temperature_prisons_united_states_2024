---
title: "Supplementary Figures 3 and 4"
...
```{r}
head(dat.wbgt.summarised.merged.weighted.prison.5year.average) #figure 3a and 4a
readr::write_csv(dat.wbgt.summarised.merged.weighted.prison.5year.average ,paste0(wbgtmax.folder,'S_Figure_3a_4a.csv'))


sfig_3b_4b <-  USA.df.merged %>% janitor::clean_names() %>% 
  dplyr::select(prison_id,name,type,population,annual_change_wbgt_26,total_change_wbgt_26,
                annual_change_wbgt_30,total_change_wbgt_30) %>% distinct()
readr::write_csv(sfig_3b_4b ,paste0(wbgtmax.folder,'S_Figure_3b_4b.csv'))
